...
exports.respondToNewGame = async ({ actions, user, channel, message_ts }) => {
  ...
  // This hacky-ness is to prevent more than 4 people from ever showing in the list
      ...
      bot.chat.postMessage(
        ...
        '<!channel> We got a game of foos! Your teams are:',
        {
          attachments: [
            ...attachments,
            {
			        "fallback": "(awesome foos gif)",
              "image_url": "https://media3.giphy.com/media/cFFUdp9B4VGUM/giphy-downsized.gif"
            }
          ]
        }
      )
